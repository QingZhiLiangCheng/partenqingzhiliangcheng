            ...
            <div className="home_container">
                <div className="home_content content">
                    ...
                    <div className="home_img">
                        <svg width="500" viewBox="0 0 692.68 534.44">
                            <path id="uuid-afa4718a-41ef-46ad-9f1b-fdedc1410b9c-161"
                            ...
                            <path
                                ...
                                fill="#2f2e41"/>
                            <path id="uuid-b608ab84-b9cd-47a8-808f-666f8f7d666f-162"
                            ...
                            <path
                                ...
                                fill="#2f2e41"/>
                            <path id="uuid-2fb5f450-2303-4fbd-97a7-1c64874c1514-163"
                            ...
                            <path
                                ...
                                fill="#6c63ff"/>
                            <path id="uuid-2ae02034-8b61-43cb-9dde-8a75b258f379-164"
                    ...
                    <div className="home_data">
                        <BoxReveal boxColor={"#6d56de"} duration={0.5}>
                            <h1 className="home_title" id="home_title">
                                欢迎来到情栀凉橙的智慧星球
                            </h1>
                        </BoxReveal>
                        <h3 className="home_subtitle" id="home_subtitle">
                            QingZhiLiangCheng WisdomPlanet
                        </h3>
                        <TypingAnimation className={"home_description"}>
                            幸福就是 橙子🍊不去想苹果🍎的事情
                        </TypingAnimation>


                        <a href="#contact" className="button button-flex">
                            <span id="home_contact">Contact Me</span>
                ...
                <div className="home_scroll">
                    <a href="#about" className="home_scroll-button button--flex">
                        <i className="uil uil-mouse-alt-2 home_scroll-mouse"></i>
                        <span className="home_scroll-name" id="home_scroll-name">
                            Scroll down
                        </span>
